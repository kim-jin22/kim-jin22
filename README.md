...
|---|---|---|---|
| [단체복 커머스 반복업무 자동화 시스템]([https://kim-jin22.github.io/danchebok-automation/](https://github.com/kim-jin22/danchebok-automation) | 단체복 B2B 커머스 반복 사고 7종을 게이트로 예방하는 인터랙티브 자동화 프로토타입 (개인 프로젝트) | 기획 · 설계 · 프론트엔드 단독 구현 | HTML/CSS/JS, Claude Code |
...
- 2026.01 - 2026.05 : 아시아경제 AI 부트캠프(596H) - 빅데이터 기반 AI 서비스 기획 & 개발, 3개 프로젝트 수행
- 2025.09 - 2025.10 : (주)이마트 해외소싱상품본부(계약) - 디자이너
- 2022.07 - 2025.02 : (주)더아이핏 온라인사업1팀 - 디자이너/담당자 (시안 디자인부터 발주·CS·매뉴얼까지 운영 전반)
- 2020.09 - 2022.01 : (주)혜인이엔씨 사업개발본부 - 디자이너 (사업 제안서·전략 보고서를 표·다이어그램으로 구조화)

## Contact

- Email : k01033126956@gmail.com
- GitHub : [@kim-jin22](https://github.com/kim-jin22)
