...
|---|---|---|---|
| [단체복 커머스 반복업무 자동화 시스템](https://github.com/kim-jin22/danchebok-automation) | 단체복 B2B 커머스 반복 사고 7종을 게이트로 예방하는 인터랙티브 자동화 프로토타입 (개인 프로젝트) | 기획 · 설계 · 프론트엔드 단독 구현 | HTML/CSS/JS, Claude Code |
